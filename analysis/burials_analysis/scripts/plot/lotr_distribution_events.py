...
output_path = os.path.join(output_folder, "lotr_burials_distribution_events.png")
...
ax.set_ylabel("Total Number of Burial Events", fontsize=14)
...
ax.set_title("Distribution of The Lord of the Rings Burial Events across Equal Sized Textual Blocks", fontsize=16)
