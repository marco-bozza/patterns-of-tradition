...
# Paths
data_dir = "D:/Archivio/Documenti/Tesi/Data/gift_giving_analysis/data"
xml_path = os.path.join(data_dir, "lotr.xml")
events_path = "D:/Archivio/Documenti/Tesi/Data/gift_giving_analysis/output/extractions/lotr_complete_events.xlsx"
output_dir = "D:/Archivio/Documenti/Tesi/Data/gift_giving_analysis/output/extractions"
...
for idx, token in enumerate(all_tokens, start=1):
    token_id = token.attrib.get('{http://www.w3.org/XML/1998/namespace}id')  # this is the correct way to get xml:id
    if token_id:
