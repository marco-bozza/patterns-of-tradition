...
# Absolute frequency and relative frequency (per 10,000 tokens) of complete events (based on unique IDs)
...
# Frequency of giver categories (relative frequency per unique events)
...
save_excel(freq_giver, "beowulf_freq_giver")

# Frequency of gift categories (relative frequency per total events — includes duplicates)
...
save_excel(freq_gift, "beowulf_freq_gift")

# Frequency of recipient categories (relative frequency per unique events)
...
save_excel(freq_recipient, "beowulf_freq_recipient")
