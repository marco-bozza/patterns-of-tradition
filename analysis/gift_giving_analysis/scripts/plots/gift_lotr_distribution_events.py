...
output_path = os.path.join(output_folder, "lotr_distribution_events.png")
...
ax.set_title("Distribution of The Lord of the Rings Gift-Giving Events across Equal Sized Textual Blocks", fontsize=16)
