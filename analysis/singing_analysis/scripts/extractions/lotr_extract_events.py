...
if __name__ == "__main__":
    excel_path = "D:/Archivio/Documenti/Tesi/Data/singing_analysis/data/lotr_songs.xlsx"
    xml_path = "D:/Archivio/Documenti/Tesi/Data/singing_analysis/data/lotr.xml"

    df, total_tokens = prepare_dataframe(excel_path, xml_path)
    
    # Save output
    output_path = "D:/Archivio/Documenti/Tesi/Data/singing_analysis/output/extractions/lotr_complete_events.xlsx"
