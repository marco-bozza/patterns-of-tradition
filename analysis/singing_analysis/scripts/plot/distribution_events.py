...
output_table_path = os.path.join(base_path, "output", "tables", "songs_distribution_events.xlsx")
output_graph_path = os.path.join(base_path, "output", "graphs", "songs_distribution_events.png")
...
ax.set_ylabel("Relative Frequency (% of Total Singing Events)", fontsize=14)
ax.set_ylim(bottom=0)
ax.legend()
ax.grid(axis="y", linestyle="--", alpha=0.6)
ax.set_title("Distribution of Singing Events across Equal Sized Textual Blocks", fontsize=16)
