...
# === Load data ===
file_path = "D:/Archivio/Documenti/Tesi/Data/singing_analysis/output/extractions/beowulf_freq_pairs.xlsx"
...
# === Title and Colorbar ===
plt.title("Heatmap of Singing in Beowulf", fontsize=16, pad=20)
...
# === Save ===
plt.tight_layout()
plt.savefig("D:/Archivio/Documenti/Tesi/Data/singing_analysis/output/graphs/singing_beowulf_heatmap.png", dpi=300)
plt.close()
